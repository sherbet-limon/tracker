...
func (t Training) distance() float64 {
	...
	distInKm := float64(t.Action) * LenStep / float64(MInKm)
	return distInKm
}
...
func (t Training) meanSpeed() float64 {
	// вставьте ваш код ниже
	speedKmInHours := t.distance() / t.Duration.Hours()
	return speedKmInHours
}
...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	kkalRun := ((CaloriesMeanSpeedMultiplier*r.meanSpeed() + CaloriesMeanSpeedShift) * r.Weight / MInKm * r.Training.Duration.Hours() * MinInHours)
	return kkalRun
}
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	kkalWalk := ((CaloriesWeightMultiplier*w.Weight + math.Pow((w.meanSpeed()*KmHInMsec), 2)/w.Height) * CaloriesSpeedHeightMultiplier * w.Weight) * w.Duration.Hours() * float64(MinInHours)
	return kkalWalk
}
...
func (s Swimming) meanSpeed() float64 {
	// вставьте ваш код ниже
	speedSwimKmInHours := float64(s.LengthPool) * float64(s.CountPool) / float64(MInKm) / s.Duration.Hours()
	return speedSwimKmInHours
}
...
func (s Swimming) Calories() float64 {
	// вставьте ваш код ниже
	kkalSwim := (s.meanSpeed() + SwimmingCaloriesMeanSpeedShift) * SwimmingCaloriesWeightMultiplier * s.Weight * s.Duration.Hours()
	return kkalSwim
}
